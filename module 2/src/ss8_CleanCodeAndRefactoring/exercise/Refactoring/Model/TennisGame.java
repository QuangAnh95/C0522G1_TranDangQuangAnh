package ss8_CleanCodeAndRefactoring.exercise.Refactoring.Model;
...
public class TennisGame {
    ...
    public static String result(int firstScore, int secondScore) {
        ...
        if (result == 1) return "Advantage player1";
        else if (result == -1) return "Advantage player2";
        else if (result >= 2) return "Win for player1";
